...
az acr build -t $IMAGE_TAG -f $BASE_PATH/vllm-phi3.dockerfile -r $ACR_NAME $BASE_PATH
# </build_image> 
...
# az ml online-deployment create -n blue --endpoint-name $ENDPOINT_NAME -f $BASE_PATH/vllm-phi3-deployment.yml --all-traffic
# # </create_deployment>
...
# # <create_deployment> 
# change_vars $BASE_PATH/vllm-phi3-deployment.yml
# az ml online-deployment create -f $BASE_PATH/vllm-phi3-deployment.yml_ --all-traffic
# # </create_deployment> 
