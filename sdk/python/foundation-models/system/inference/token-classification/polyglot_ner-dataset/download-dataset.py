...
parser.add_argument(
    "--dataset", type=str, default="polyglot_ner", help="dataset name"
)
# add an argument to specify the config name to download
parser.add_argument(
    "--config_name", type=str, default="fr", help="config name"
)
...
for split in get_dataset_split_names(args.dataset, args.config_name):
