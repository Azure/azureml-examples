...
parser.add_argument('--config_name', type=str, default='plain_text', help='config name of the dataset')
# argument to save a fraction of the dataset
parser.add_argument('--fraction', type=float, default=0.05, help='fraction of the dataset to save')
