...
def main(args):
    ...
    preprocessed_train_dataframe.to_csv(args.preprocess_train_data+'/yelp_training_set.csv',index = False, header = True)
    ...
    preprocessed_validation_dataframe.to_csv(args.preprocess_validation_data+'/yelp_validation_set.csv',index = False, header = True)
