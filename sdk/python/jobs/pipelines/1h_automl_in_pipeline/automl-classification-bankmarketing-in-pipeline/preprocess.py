...
def main(args):
    ...
    preprocessed_train_dataframe.to_csv(args.preprocess_train_data+'/bank_marketing_train_data.csv',index = False, header = True)
    ...
    preprocessed_validation_dataframe.to_csv(args.preprocess_validation_data+'/bank_marketing_validation_data.csv',index = False, header = True)
