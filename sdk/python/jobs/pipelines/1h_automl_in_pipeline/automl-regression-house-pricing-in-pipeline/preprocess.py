...
def main(args):
    ...
    preprocessed_train_dataframe.to_csv(args.preprocess_train_data+'/house_pricing_train.csv',index = False, header = True)
    ...
    preprocessed_validation_dataframe.to_csv(args.preprocess_validation_data+'/house_pricing_validation.csv',index = False, header = True)
    ...
    # write preprocessed validation data in output path
    preprocessed_test_dataframe.to_csv(args.preprocess_test_data+'/house_pricing_test.csv',index = False, header = True)
