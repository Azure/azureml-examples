...
parser.add_argument("--evaluation_input", type=str, help="Path to input evaluation result data")
parser.add_argument("--model_output", type=str, help="Path of output model to be registered")
