...
name: Azure.ResourceManager.MachineLearning samples for .NET
description: Samples for the Azure.ResourceManager.MachineLearning client library
---


# Azure ResourceManager MachineLearning client library/Samples for .NET
...
- If you find a bug or have a suggestion, file an issue via [GitHub issues](https://github.com/Azure/azureml-examples/issues).

## Next steps

### More sample code

- Basic Samples: [Azure.ResourceManager Samples](https://github.com/Azure/azure-sdk-for-net/tree/main/sdk/resourcemanager/Azure.ResourceManager/samples).
- Samples for the Azure.ResourceManager.MachineLearning: [Managing Machine Learning services](https://github.com/Azure/azureml-samples-dotnet/blob/main/Program.cs).

| Entity Type/Operation | Is Sample available |
|-|-|
| ResourceGroup | yes |
| EnvironmentVersion | yes |
| CodeVersion | yes |
| Data | yes |
| Datastore | yes |
| ModelVersion | yes |
| AmlCompute | yes |
| AKSCompute | yes |
| ComponentVersion | yes |
| OnlineEndpoint | yes |
| OnlineDeployment | yes |
| Invoke OnlineEndpoint | yes |
| BatchEndpoint | yes |
| BatchDeployment | yes |
| Invoke BatchEndpoint | yes |
| AutoML Job | yes |
| CommandJob | yes |
| SweepJob | yes |
| PipelineJob | yes |
