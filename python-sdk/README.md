...
[deploy-with-prebuilt-docker-images](tutorials/deploy-with-prebuilt-docker-images)|[![deploy-with-prebuilt-docker-images](https://github.com/Azure/azureml-examples/workflows/python-sdk-tutorial-deploy-with-prebuilt-docker-images/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Apython-sdk-tutorial-deploy-with-prebuilt-docker-images)|[pytorch-prebuilt-docker-image.ipynb](tutorials/deploy-with-prebuilt-docker-images/pytorch-prebuilt-docker-image.ipynb)|Learn how to deploy models in Azure Machine Learning using Prebuilt docker images for Inference.
