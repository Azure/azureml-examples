...
[using-pipelines](tutorials/using-pipelines)|[![using-pipelines](https://github.com/Azure/azureml-examples/workflows/python-sdk-tutorial-using-pipelines/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Apython-sdk-tutorial-using-pipelines)|[aml-pipelines-publish-and-run-using-rest-endpoint.ipynb](tutorials/using-pipelines/aml-pipelines-publish-and-run-using-rest-endpoint.ipynb)<br>[aml-pipelines-showcasing-dataset-and-pipelineparameter.ipynb](tutorials/using-pipelines/aml-pipelines-showcasing-dataset-and-pipelineparameter.ipynb)<br>[pipeline-for-image-classification.ipynb](tutorials/using-pipelines/pipeline-for-image-classification.ipynb)<br>[pipeline-style-transfer-parallel-run.ipynb](tutorials/using-pipelines/pipeline-style-transfer-parallel-run.ipynb)|*no description*
