...
-|-|-|-|-
[deploy-edge](experimental/deploy-edge)|[![deploy-edge](https://github.com/Azure/azureml-examples/workflows/python-sdk-tutorial-deploy-edge/badge.svg?branch=main)](https://github.com/Azure/azureml-examples/actions/workflows/python-sdk-tutorial-deploy-edge.yml)|[ase-gpu.ipynb](experimental/deploy-edge/ase-gpu.ipynb)|Learn how to deploy models to Edge devices using Azure ML.|untested portions of tutorial
...
[using-xgboost](experimental/using-xgboost)|[![using-xgboost](https://github.com/Azure/azureml-examples/workflows/python-sdk-tutorial-using-xgboost/badge.svg?branch=main)](https://github.com/Azure/azureml-examples/actions/workflows/python-sdk-tutorial-using-xgboost.yml)|[1.local-eda.ipynb](experimental/using-xgboost/1.local-eda.ipynb)<br>[2.distributed-cpu.ipynb](experimental/using-xgboost/2.distributed-cpu.ipynb)|Learn how to use [XGBoost](https://github.com/dmlc/xgboost) with Azure ML.|issues with multinode xgboost
