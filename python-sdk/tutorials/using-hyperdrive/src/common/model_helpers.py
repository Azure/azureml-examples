...
def write_model_info(folder_path: str, filename: str, model_info: dict) -> str:
    ...
    ----------
    folder_path : str
        folder of file containing model information
    filename : str
        filename of file contianing model information
    model_info : dict
        model information to be written as JSON

    Returns
    -------
    str
        File path of newly created file containing model information
    """
