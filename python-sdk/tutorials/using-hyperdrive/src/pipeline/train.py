...
from src.model.algorithms import train_fake_model
...
@click.option("--initial_lr", type=click.FLOAT, required=True, default=0.01,
...
def main(root_dir: str,
    ...
    """
    Main function for receiving args, and passing them
    through to a basic training step
    ...
    # Run fake training step
    model_info = train_fake_model(initial_lr)
