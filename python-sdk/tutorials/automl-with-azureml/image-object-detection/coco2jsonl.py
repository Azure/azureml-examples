...
class BoundingBoxConverter(CocoToJSONLinesConverter):
    ...
    def _populate_image_details(self, index, coco_image):
        ...
        self.json_lines_data[index]['image_details']["format"] = file_name[file_name.rfind(".")+1:]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--task_type', type=str, required=True, choices=['ObjectDetection'], default='ObjectDetection')
