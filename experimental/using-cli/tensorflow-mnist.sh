...
# <create compute>
#az ml compute create -n gpu-cluster --min-node-count 0 --max-node-count 20 --size Standard_NC24_v3
# </create compute>

# <create a basic job>
job_id=`az ml job create -f jobs/train/tensorflow/mnist-horovod/tf_horovod_job.yml -o tsv | cut -f11`
# </create a basic job>
