...
[using-optuna](tutorials/using-optuna)|[![using-optuna](https://github.com/Azure/azureml-examples/workflows/run-tutorial-uo/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Arun-tutorial-uo)||*no description*
...
[workflows/train/transformers/1-aml-finetune-job.py](workflows/train/transformers/1-aml-finetune-job.py)|AML - GPU|pip|Submit GLUE finetuning with Huggingface transformers library on Azure ML
[workflows/train/transformers/2-aml-comparison-of-sku-job.py](workflows/train/transformers/2-aml-comparison-of-sku-job.py)|AML - CPU|pip|Experiment comparing training performance of GLUE finetuning task with differing hardware.
[workflows/train/transformers/3-aml-hyperdrive-job.py](workflows/train/transformers/3-aml-hyperdrive-job.py)|AML - GPU|pip|Automatic hyperparameter optimization with Azure ML HyperDrive library.
