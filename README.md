...
[deploy-k8sedge](tutorials/deploy-k8sedge)|[![deploy-k8sedge](https://github.com/Azure/azureml-examples/workflows/run-tutorial-dk/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Arun-tutorial-dk)|[production-deploy-to-k8s-gpu.ipynb](tutorials/deploy-k8sedge/production-deploy-to-k8s-gpu.ipynb)|learn how to use Kubernetes on Edge device for deployment and inferencing
