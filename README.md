...
[using-xgboost](tutorials/using-xgboost)|[![using-xgboost](https://github.com/Azure/azureml-examples/workflows/run-tutorial-ux/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Arun-tutorial-ux)|[0.Untitled.ipynb](tutorials/using-xgboost/0.Untitled.ipynb)<br>[1.distributed-cpu.ipynb](tutorials/using-xgboost/1.distributed-cpu.ipynb)|learn how to use [XGBoost](https://github.com/dmlc/xgboost) distributed on Azure
