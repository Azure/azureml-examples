...
[deploy-k8sedge](tutorials/using-k8sedge)|[![deploy-k8sedge](https://github.com/Azure/azureml-examples/workflows/run-tutorial-uk/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Arun-tutorial-uk)|[production-deploy-to-k8s-gpu.ipynb](tutorials/using-k8sedge/production-deploy-to-k8s-gpu.ipynb)| learn how to use Kubernetes on Edge device for deployment and inferencing
