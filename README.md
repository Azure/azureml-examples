...
[using-k8sedge](tutorials/using-k8sedge)|[![using-k8sedge](https://github.com/Azure/azureml-examples/workflows/run-tutorial-uk/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Arun-tutorial-uk)|[production-deploy-to-k8s-gpu.ipynb](tutorials/using-k8sedge/production-deploy-to-k8s-gpu.ipynb)|*no description*
