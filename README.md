...
[deploying-to-edge](tutorials/deploying-to-edge)|[![deploying-to-edge](https://github.com/Azure/azureml-examples/workflows/run-tutorial-dte/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Arun-tutorial-dte)|[production-deploy-to-ase-gpu.ipynb](tutorials/deploying-to-edge/production-deploy-to-ase-gpu.ipynb)|learn how to deploy models with Azure ML service to Azure Stack Edge using IOT Edge
