...
[deploy-aks-modeldata](tutorials/deploy-aks-modeldata)|[![deploy-aks-modeldata](https://github.com/Azure/azureml-examples/workflows/run-tutorial-dam/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Arun-tutorial-dam)|[deploy-aks-modeldata.ipynb](tutorials/deploy-aks-modeldata/deploy-aks-modeldata.ipynb)|learn how to deploy a model in AML as a web service in Azure Kubernetes Services (AKS) with Model Data Collection.
