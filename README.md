...
-|-|-
[aml-pipelines-publish-and-run-using-rest-endpoint.ipynb](notebooks/machine-learning-pipelines/intro-to-pipelines/aml-pipelines-publish-and-run-using-rest-endpoint.ipynb)|[![aml-pipelines-publish-and-run-using-rest-endpoint](https://github.com/Azure/azureml-examples/workflows/notebook-aml-pipelines-publish-and-run-using-rest-endpoint/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Anotebook-aml-pipelines-publish-and-run-using-rest-endpoint)|*no description*
[aml-pipelines-showcasing-dataset-and-pipelineparameter.ipynb](notebooks/machine-learning-pipelines/intro-to-pipelines/aml-pipelines-showcasing-dataset-and-pipelineparameter.ipynb)|[![aml-pipelines-showcasing-dataset-and-pipelineparameter](https://github.com/Azure/azureml-examples/workflows/notebook-aml-pipelines-showcasing-dataset-and-pipelineparameter/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Anotebook-aml-pipelines-showcasing-dataset-and-pipelineparameter)|*no description*
[pipeline-for-image-classification.ipynb](notebooks/machine-learning-pipelines/intro-to-pipelines/pipeline-for-image-classification.ipynb)|[![pipeline-for-image-classification](https://github.com/Azure/azureml-examples/workflows/notebook-pipeline-for-image-classification/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Anotebook-pipeline-for-image-classification)|*no description*
[pipeline-style-transfer-parallel-run.ipynb](notebooks/machine-learning-pipelines/intro-to-pipelines/pipeline-style-transfer-parallel-run.ipynb)|[![pipeline-style-transfer-parallel-run](https://github.com/Azure/azureml-examples/workflows/notebook-pipeline-style-transfer-parallel-run/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Anotebook-pipeline-style-transfer-parallel-run)|*no description*
