...
export ENDPOINT_FILE_PATH="endpoints/online/managed/vnet-legacy/sample/endpoint.yml"
export DEPLOYMENT_FILE_PATH="endpoints/online/managed/vnet-legacy/sample/blue-deployment-vnet.yml"
export SAMPLE_REQUEST_PATH="endpoints/online/managed/vnet-legacy/sample/sample-request.json"
export ENV_DIR_PATH="endpoints/online/managed/vnet-legacy/sample/environment"
# </set_env_vars>
