...
```
manoj@Azure:~/clouddrive/repos/AzureML/samples/2a_basic_component$ az ml job create --file pipeline.yml --set jobs.hello_python_world_job.compute.target=cpu-cluster
