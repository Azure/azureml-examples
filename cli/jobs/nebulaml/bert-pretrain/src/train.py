...
if __name__ == "__main__":
    ...
    embedding_size = 768
    sequence_length = 512
    embedding_flops = embedding_size * sequence_length * 2  # 2 FLOPs for each multiplication and addition operation

    # calculate FLOPs for transformer layers
    hidden_size = 768
    num_layers = 12
    transformer_flops = hidden_size * sequence_length * 3 * 2 * num_layers  # 3 matrix multiplications, 2 layer norm ops
    ...
    forward_passes_per_second = compute_training_samples_per_second / training_args.per_device_train_batch_size
