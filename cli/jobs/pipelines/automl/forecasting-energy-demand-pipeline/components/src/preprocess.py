...
def main(args):
    ...
    preprocessed_train_data_path = os.path.join(args.preprocessed_train_data, "nyc_energy_training_clean.csv")
    ...
    preprocessed_validation_data_path = os.path.join(args.preprocessed_validation_data, "nyc_energy_validation_clean.csv")
