...
def main(args):
    ...
    preprocessed_train_data_path = os.path.join(args.preprocessed_train_data, "train_data.csv")
    ...
    preprocessed_validation_data_path = os.path.join(args.preprocessed_validation_data, "valid_data.csv")
