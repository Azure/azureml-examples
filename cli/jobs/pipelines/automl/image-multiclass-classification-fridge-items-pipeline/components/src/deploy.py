...
from azure.ai.ml.entities import ManagedOnlineEndpoint,ManagedOnlineDeployment,ProbeSettings
...
def parse_args():
    ...
    # add arguments
    parser.add_argument("--model_id_path", type=str, help="Path where registered model id is saved")
    parser.add_argument(
        "--endpoint_name", type=str, help="Name of the the endpoint where model needs to be deployed"
    )
    parser.add_argument(
