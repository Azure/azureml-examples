...
# <create_endpoint>
az ml online-endpoint create --name $ENDPOINT_NAME -f endpoints/online/kubernetes/endpoint.yml
# </create_endpoint>

# <create_blue>
az ml online-deployment create --name blue --endpoint $ENDPOINT_NAME -f endpoints/online/kubernetes/blue-deployment.yml --all-traffic
# </create_blue>
...
# <create_green>
az ml online-deployment create --name green --endpoint $ENDPOINT_NAME -f endpoints/online/kubernetes/green-deployment.yml
# </create_green>
