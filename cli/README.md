...
[deploy-managed-endpoint-access-resources-sai.sh](deploy-managed-endpoint-access-resources-sai.sh)|[![deploy-managed-endpoint-access-resources-sai](https://github.com/Azure/azureml-examples/workflows/cli-scripts-deploy-managed-endpoint-access-resources-sai/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Acli-scripts-deploy-managed-endpoint-access-resources-sai)
[deploy-managed-endpoint-access-resources.sh](deploy-managed-endpoint-access-resources.sh)|[![deploy-managed-endpoint-access-resources](https://github.com/Azure/azureml-examples/workflows/cli-scripts-deploy-managed-endpoint-access-resources/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Acli-scripts-deploy-managed-endpoint-access-resources)
