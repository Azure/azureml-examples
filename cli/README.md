...
-|-|-
[jobs/dataprep/dask/dask-job.yml](jobs/dataprep/dask/dask-job.yml)|[![jobs/dataprep/dask/dask-job](https://github.com/Azure/azureml-examples/workflows/cli-jobs-dataprep-dask-dask-job/badge.svg)](https://github.com/Azure/azureml-examples/actions/workflows/cli-jobs-dataprep-dask-dask-job.yml)|This sample shows how to run a distributed DASK job on AzureML.
