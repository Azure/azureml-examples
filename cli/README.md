...
[jobs/train/lightgbm/iris-notebook/job.yml](jobs/train/lightgbm/iris-notebook/job.yml)|[![jobs/train/lightgbm/iris-notebook/job](https://github.com/Azure/azureml-examples/workflows/cli-jobs-train-lightgbm-iris-notebook-job/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Acli-jobs-train-lightgbm-iris-notebook-job)|Train a LightGBM model on the Iris dataset via python notebook and papermill.
