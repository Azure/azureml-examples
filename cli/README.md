...
[jobs/train/scikit-learn/diabetes/job.yml](jobs/train/scikit-learn/diabetes/job.yml)|[![jobs/train/scikit-learn/diabetes/job](https://github.com/Azure/azureml-examples/workflows/cli-jobs-train-scikit-learn-diabetes-job/badge.svg)](https://github.com/Azure/azureml-examples/actions/workflows/cli-jobs-train-scikit-learn-diabetes-job.yml)|Train a scikit-learn LogisticRegression model on the Diabetes dataset.
