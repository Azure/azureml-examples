...
[configure-cli.sh](configure-cli.sh)|[![configure-cli](https://github.com/Azure/azureml-examples/workflows/cli-scripts-configure-cli/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Acli-scripts-configure-cli)
...
[deploy-manage-endpoint-access-resources-sai.sh](deploy-manage-endpoint-access-resources-sai.sh)|[![deploy-manage-endpoint-access-resources-sai](https://github.com/Azure/azureml-examples/workflows/cli-scripts-deploy-manage-endpoint-access-resources-sai/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Acli-scripts-deploy-manage-endpoint-access-resources-sai)
[deploy-manage-endpoint-access-resources.sh](deploy-manage-endpoint-access-resources.sh)|[![deploy-manage-endpoint-access-resources](https://github.com/Azure/azureml-examples/workflows/cli-scripts-deploy-manage-endpoint-access-resources/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Acli-scripts-deploy-manage-endpoint-access-resources)
...
[deploy-triton.sh](deploy-triton.sh)|[![deploy-triton](https://github.com/Azure/azureml-examples/workflows/cli-scripts-deploy-triton/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Acli-scripts-deploy-triton)
[how-to-batch-score.sh](how-to-batch-score.sh)|[![how-to-batch-score](https://github.com/Azure/azureml-examples/workflows/cli-scripts-how-to-batch-score/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Acli-scripts-how-to-batch-score)
[how-to-configure-cli.sh](how-to-configure-cli.sh)|[![how-to-configure-cli](https://github.com/Azure/azureml-examples/workflows/cli-scripts-how-to-configure-cli/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Acli-scripts-how-to-configure-cli)
[how-to-deploy-declarative-safe-rollout-online-endpoints.sh](how-to-deploy-declarative-safe-rollout-online-endpoints.sh)|[![how-to-deploy-declarative-safe-rollout-online-endpoints](https://github.com/Azure/azureml-examples/workflows/cli-scripts-how-to-deploy-declarative-safe-rollout-online-endpoints/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Acli-scripts-how-to-deploy-declarative-safe-rollout-online-endpoints)
[how-to-deploy-imperative-safe-rollout-online-endpoints.sh](how-to-deploy-imperative-safe-rollout-online-endpoints.sh)|[![how-to-deploy-imperative-safe-rollout-online-endpoints](https://github.com/Azure/azureml-examples/workflows/cli-scripts-how-to-deploy-imperative-safe-rollout-online-endpoints/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Acli-scripts-how-to-deploy-imperative-safe-rollout-online-endpoints)
[how-to-deploy-managed-online-endpoint-access-resource-sai.sh](how-to-deploy-managed-online-endpoint-access-resource-sai.sh)|[![how-to-deploy-managed-online-endpoint-access-resource-sai](https://github.com/Azure/azureml-examples/workflows/cli-scripts-how-to-deploy-managed-online-endpoint-access-resource-sai/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Acli-scripts-how-to-deploy-managed-online-endpoint-access-resource-sai)
[how-to-deploy-managed-online-endpoint-access-resource-uai.sh](how-to-deploy-managed-online-endpoint-access-resource-uai.sh)|[![how-to-deploy-managed-online-endpoint-access-resource-uai](https://github.com/Azure/azureml-examples/workflows/cli-scripts-how-to-deploy-managed-online-endpoint-access-resource-uai/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Acli-scripts-how-to-deploy-managed-online-endpoint-access-resource-uai)
[how-to-deploy-managed-online-endpoint.sh](how-to-deploy-managed-online-endpoint.sh)|[![how-to-deploy-managed-online-endpoint](https://github.com/Azure/azureml-examples/workflows/cli-scripts-how-to-deploy-managed-online-endpoint/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Acli-scripts-how-to-deploy-managed-online-endpoint)
[how-to-deploy-multiple-models-triton-online-endpoint.sh](how-to-deploy-multiple-models-triton-online-endpoint.sh)|[![how-to-deploy-multiple-models-triton-online-endpoint](https://github.com/Azure/azureml-examples/workflows/cli-scripts-how-to-deploy-multiple-models-triton-online-endpoint/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Acli-scripts-how-to-deploy-multiple-models-triton-online-endpoint)
[how-to-deploy-rest.sh](how-to-deploy-rest.sh)|[![how-to-deploy-rest](https://github.com/Azure/azureml-examples/workflows/cli-scripts-how-to-deploy-rest/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Acli-scripts-how-to-deploy-rest)
[how-to-deploy-tfserving.sh](how-to-deploy-tfserving.sh)|[![how-to-deploy-tfserving](https://github.com/Azure/azureml-examples/workflows/cli-scripts-how-to-deploy-tfserving/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Acli-scripts-how-to-deploy-tfserving)
[how-to-deploy-triton-ensemble-managed-online-endpoint.sh](how-to-deploy-triton-ensemble-managed-online-endpoint.sh)|[![how-to-deploy-triton-ensemble-managed-online-endpoint](https://github.com/Azure/azureml-examples/workflows/cli-scripts-how-to-deploy-triton-ensemble-managed-online-endpoint/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Acli-scripts-how-to-deploy-triton-ensemble-managed-online-endpoint)
[how-to-deploy-triton.sh](how-to-deploy-triton.sh)|[![how-to-deploy-triton](https://github.com/Azure/azureml-examples/workflows/cli-scripts-how-to-deploy-triton/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Acli-scripts-how-to-deploy-triton)
[how-to-manage-resources-cli.sh](how-to-manage-resources-cli.sh)|[![how-to-manage-resources-cli](https://github.com/Azure/azureml-examples/workflows/cli-scripts-how-to-manage-resources-cli/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Acli-scripts-how-to-manage-resources-cli)
