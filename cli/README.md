...
[create-compute-extras.sh](create-compute-extras.sh)|[![create-compute-extras](https://github.com/Azure/azureml-examples/workflows/cli-scripts-create-compute-extras/badge.svg)](https://github.com/Azure/azureml-examples/actions/workflows/cli-scripts-create-compute-extras.yml)
