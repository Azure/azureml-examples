...
[how-to-deploy-triton-ensemble-managed-online-endpoint.sh](how-to-deploy-triton-ensemble-managed-online-endpoint.sh)|[![how-to-deploy-triton-ensemble-managed-online-endpoint](https://github.com/Azure/azureml-examples/workflows/cli-docs-how-to-deploy-triton-ensemble-managed-online-endpoint/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Acli-docs-how-to-deploy-triton-ensemble-managed-online-endpoint)
[how-to-deploy-triton-managed-online-endpoint.sh](how-to-deploy-triton-managed-online-endpoint.sh)|[![how-to-deploy-triton-managed-online-endpoint](https://github.com/Azure/azureml-examples/workflows/cli-docs-how-to-deploy-triton-managed-online-endpoint/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Acli-docs-how-to-deploy-triton-managed-online-endpoint)
