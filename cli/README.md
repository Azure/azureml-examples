...
[create-workspace-private-link-endpoint.sh](create-workspace-private-link-endpoint.sh)|[![create-workspace-private-link-endpoint](https://github.com/Azure/azureml-examples/workflows/cli-scripts-create-workspace-private-link-endpoint/badge.svg?branch=main)](https://github.com/Azure/azureml-examples/actions/workflows/cli-scripts-create-workspace-private-link-endpoint.yml)
...
[jobs/pipelines/basics/hello-world-io.yml](jobs/pipelines/basics/hello-world-io.yml)|[![jobs/pipelines/basics/hello-world-io](https://github.com/Azure/azureml-examples/workflows/cli-jobs-pipelines-basics-hello-world-io/badge.svg?branch=main)](https://github.com/Azure/azureml-examples/actions/workflows/cli-jobs-pipelines-basics-hello-world-io.yml)|*no description*
...
[assets/workspace/hbi.yml](assets/workspace/hbi.yml)|[![assets/workspace/hbi](https://github.com/Azure/azureml-examples/workflows/cli-assets-workspace-hbi/badge.svg?branch=main)](https://github.com/Azure/azureml-examples/actions/workflows/cli-assets-workspace-hbi.yml)|This configuration shows how to configure a workspace with the hbi flag enabled. This flag specifies whether to reduce telemetry collection and enable additional encryption when high-business-impact data is used.
