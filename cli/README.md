...
[configure.sh](configure.sh)|[![configure](https://github.com/Azure/azureml-examples/workflows/cli-scripts-configure/badge.svg)](https://github.com/Azure/azureml-examples/actions?query=workflow%3Acli-scripts-configure)
