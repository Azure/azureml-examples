...
def train(sample_input, model_pkl):
    ...
    X_train, X_test, y_train, y_test = train_test_split(
        iris.data, iris.target, train_size=0.9
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--sample-input",
        required=False,
        default="./endpoints/online/inference-schema/sample-input-iris.json",
    )
    parser.add_argument(
        "--model-pkl",
        required=False,
        default="./endpoints/online/inference-schema/iris.pkl",
    )
