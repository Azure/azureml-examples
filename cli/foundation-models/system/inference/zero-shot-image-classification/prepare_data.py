...
def upload_data_and_extract(dataset_parent_dir: str) -> str:
    """Extract image dataset from local path.
    ...
    local_data_path = repo_root / "sample-data" / "image-classifcation" / "fridgeObjects.zip"
