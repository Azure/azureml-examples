set -x
# the commands in this file map to steps in this notebook: https://aka.ms/azureml-ft-sdk-mmd-image-instance-segmentation
...
mmdetection_model_name="mask_rcnn_r50_fpn_1x_coco"
model_version=1

version=$(date +%s)
finetuned_mmdetection_model_name="mask_rcnn_r50_fpn_fridge_objects_detection"
...
# inputs.model_name="mask_rcnn_r50_fpn_1x_coco"
