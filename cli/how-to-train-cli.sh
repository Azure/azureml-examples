...
# <lightgbm_iris_local>
job_id=`az ml job create -f jobs/train/lightgbm/iris/basic.yml --set compute.target=local --query name -o tsv`
# </lightgbm_iris_local>
...
# <lightgbm_iris_sweep>
job_id=`az ml job create -f jobs/train/lightgbm/iris/sweep.yml --query name -o tsv`
# </lightgbm_iris_sweep>
